...
/* ============================================================
   ...
   ============================================================ */
const IMAGE_PATHS = {
  // Package card thumbnails (for index.html popular packages)
  packages: {
    tirumala: "images/card-tirumala.jpg",
    tirupati: "images/card-tirupati.jpg",
    kalahasti: "images/card-kalahasti.jpg",
    kanipakam: "images/card-kanipakam.jpg",
    arunachalam: "images/card-arunachalam.jpg",
    yatra: "images/card-yatra.jpg",
    transfer: "images/card-transfer.jpg"
  },

  // Package detail images (for package.html big hero image)
  packageDetails: {
    tirumala: "images/detail-tirumala.jpg",
    tirupati: "images/detail-tirupati.jpg",
    kalahasti: "images/detail-kalahasti.jpg",
    kanipakam: "images/detail-kanipakam.jpg",
    arunachalam: "images/detail-arunachalam.jpg",
    yatra: "images/detail-yatra.jpg",
    transfer: "images/detail-transfer.jpg"
  },
...
/**
 * Get image path for a package by category
 * @param {string} category - Package category (tirumala, tirupati, etc.)
 * @param {string} type - 'card' or 'detail'
 * @returns {string} Image path
 */
function getPackageImage(category, type = 'card') {
  if (type === 'card') {
    return IMAGE_PATHS.packages[category] || IMAGE_PATHS.packages.tirumala;
  }
  return IMAGE_PATHS.packageDetails[category] || IMAGE_PATHS.packageDetails.tirumala;
}
