...
const PACKAGES = [
  ...
  /* ── MULTI-DAY ──────────────────────────────────────── */
  {
    ...
    price: 11499,
    duration: "2 Days",
    routeShort: "Tirupati → Kanipakam → Golden Temple → Kanchipuram → Tiruthani Tirupati → Kanipakam → Golden Temple → Kanchipuram → Tirupati",
    ...
    highlights: ["7 Sacred Sites", "2 Full Days", "Kanipakam ,Golden Temple  Kalahasti"],
