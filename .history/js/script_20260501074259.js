...
(function initSpiritualTrack() {
    ...
    track.style.animationDuration = "500s";
...
// ============================================================
//  5a. INDEX PAGE — SPIRITUAL JOURNEY (from content-data.js)
// ============================================================
...
// ============================================================
//  5b. INDEX PAGE — CUSTOMER REVIEWS (from content-data.js)
// ============================================================
    ...
    detail.innerHTML = `
        ...
        <div class="pkg-hero-strip">
            <div class="pkg-hero-img">
                <img src="${pkg.detailImage}" alt="${pkg.name}">
